...
export default function Settings() {
  ...
  return (
    <>
      ...
      <form onSubmit={saveSettings} className="max-w-2xl rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
        ...
        <label className="mt-5 flex items-center justify-between gap-4 rounded-md border border-slate-200 p-4">
          <span>
